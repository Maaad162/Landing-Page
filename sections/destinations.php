<section class="py-5 my-5">
    <div class="container text-center">
        <span class="section-subtitle text-muted">MAIS VENDIDOS</span>
        <h2 class="display-5 fw-bold mb-5" style="color: var(--color-primary);">Top Destinos</h2>
        <div class="row g-4">
            <div class="col-lg-4 col-md-6">
                <div class="card destination-card h-100 border-0 shadow-lg rounded-4 overflow-hidden">
                    ...
                    <div class="card-body p-4 text-start bg-white">
                        ...
                        <div class="text-muted small"><i class="bi bi-send-fill me-2 text-black"></i> 10 Dias de Viagem</div>
                    </div>
                </div>
            </div>
            <div class="col-lg-4 col-md-6">
                <div class="card destination-card h-100 border-0 shadow-lg rounded-4 overflow-hidden">
                    ...
                    <div class="card-body p-4 text-start bg-white">
                        ...
                        <div class="text-muted small"><i class="bi bi-send-fill me-2 text-black"></i> 12 Dias de Viagem</div>
                    </div>
                </div>
            </div>
            <div class="col-lg-4 col-md-6">
                <div class="card destination-card h-100 border-0 shadow-lg rounded-4 overflow-hidden">
                    ...
                    <div class="card-body p-4 text-start bg-white">
                        ...
                        <div class="text-muted small"><i class="bi bi-send-fill me-2 text-black"></i> 28 Dias de Viagem</div>
                    </div>
                </div>
            </div>
        </div>
