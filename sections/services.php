<section class="py-5 position-relative">
    <div class="container text-center">
        <span class="section-subtitle text-muted">CATEGORIAS</span>
        <h2 class="display-5 fw-bold mb-5" style="color: var(--color-primary);">Oferecemos os Melhores Serviços</h2>
        <div class="row g-4">
